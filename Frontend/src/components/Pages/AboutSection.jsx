  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ backgroundImage: `url(${AboutUS})`, transform: "scaleX(1)",
        maxWidth: "100%", }}
      >
      ...
      >
        ...
        <div className="w-full md:w-2/5 px-4">
          <div className="flex flex-col md:flex-row gap-2 max-w-xl md:max-w-none mx-auto">
            ...
            />
            <button className="bg-[#088138] text-white h-12 px-4 text-base md:text-lg rounded-md md:rounded-r-md md:rounded-l-none hover:bg-[#076a63] transition-colors">
              Sign Up
            </button>
          </div>
        </div>
